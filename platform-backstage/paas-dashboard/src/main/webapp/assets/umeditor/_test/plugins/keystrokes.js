...
//    if(ua.browser.gecko){
//        var editor = te.obj[0];
//        editor.body.innerHTML = '<p>欢迎使用umeditor!</p><ol style="list-style-type:decimal;"><li><br /></li></ol>';
//        var range = te.obj[1];
//        setTimeout(function(){
//            range.setStartAtFirst(editor.body.firstChild).collapse(true);
//            ua.keyup(te.obj[0].body,{'keyCode':8});
//            setTimeout(function(){
//                equal(ua.getChildHTML(editor.body),'<p>欢迎使用umeditor!</p>','删除空行 ');
//                start();
//            },20);
//        },20);
//        stop();
...
//    var editor = te.obj[0];
//    editor.setContent( '<ol style="list-style-type:decimal;"><li><p>欢迎使用</p></li><li><p>umeditor</p></li><li><p>umeditor</p></li></ol>' );
//    var range = te.obj[1];
//    setTimeout(function(){
...
//            equal(ua.getChildHTML(te.obj[0].body.firstChild.lastChild),'<li><p>umeditor</p></li><li><p>umeditor</p></li>','检查内容');
//            start();
//        },20);
//    },50);
//    stop();
...
//            equal($(te.obj[0].body.firstChild).css('list-style-type'),'decimal','原列表类型');
//            equal(ua.getChildHTML(te.obj[0].body.firstChild.firstChild),'<li><p>欢迎使用</p></li><li><p>umeditor</p></li>','检查内容');
//            start();
//        },20);
//    },50);
//    stop();
...
//    var editor = te.obj[0];
//    editor.setContent( '<ol style="list-style-type:decimal;"><li><p>欢迎使用</p></li><li><p>umeditor</p></li></ol>' );
//    var range = te.obj[1];
//    setTimeout(function(){
...
//            equal(ua.getChildHTML(te.obj[0].body.firstChild.lastChild),'<p>umeditor</p>','检查内容');
//            start();
//        },20);
//    },50);
//    stop();
